// components/HeadJudgeLayoutClientWrapper.tsx
...
interface HeadJudgeLayoutClientWrapperProps {
    children: ReactNode;
    user: ClientUser | null; // Receive the user data pre-fetched by the server layout
}

export default function HeadJudgeLayoutClientWrapperWrapper({ children, user }: HeadJudgeLayoutClientWrapperProps) {
